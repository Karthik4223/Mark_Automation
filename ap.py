...
# # # # # # Faculty and course details input
...
# # # # #     '75-84%': {'T2_T3': 2, 'T5': 2},
# # # # #     '85-94%': {'T2_T3': 2, 'T5': 2},
# # # # #     '95% and above': {'T2_T3': 2, 'T5': 2}
# # # # # }

# # # # # # Determine attendance range category based on attendance percentage
# # # # # def get_attendance_range(attendance):
# # # # #     if attendance < 50:
# # # # #         return '0-49%'
...
# # # # #         parts = [random.randint(10, highest_mark) for _ in range(4)]
# # # # #         if tuple(parts) not in t5_patterns:
# # # # #             t5_patterns.add(tuple(parts))
# # # # #             return parts
# # # # #         return parts
...
# # # # #         attendance_range = get_attendance_range(attendance)
# # # # #         attendance_adj = attendance_adjustment[attendance_range]
...
# # # # #         # Display the processed data for the report
# # # # #         st.write("**Faculty Name:**", faculty_name)
# # # # #         st.write("**Subject Name:**", subject_name)
# # # # #         st.write("**Section:**", section)
# # # # #         st.write("**Total Number of Students:**", len(df))
        
# # # # #         # Attendance-based marks distribution
# # # # #         st.subheader("Attendance-Based Module 1 Marks Distribution")
# # # # #         attendance_ranges = ['0-49%', '50-64%', '65-74%', '75-84%', '85-94%', '95% and above']
# # # # #         mark_ranges = ['<=10', '>10 & <=20', '>20 & <=30', '>30 & <=40', '>40 & <=60']
        
# # # # #         attendance_mark_dist = pd.DataFrame(index=attendance_ranges, columns=mark_ranges).fillna(0)
# # # # #         for idx, row in df.iterrows():
# # # # #             attendance_range = get_attendance_range(row['Attendance'])
# # # # #             overall_t5_mark = row['Overall T5']
# # # # #             if overall_t5_mark <= 10:
# # # # #                 attendance_mark_dist.at[attendance_range, '<=10'] += 1
# # # # #             elif overall_t5_mark <= 20:
# # # # #                 attendance_mark_dist.at[attendance_range, '>10 & <=20'] += 1
# # # # #             elif overall_t5_mark <= 30:
# # # # #                 attendance_mark_dist.at[attendance_range, '>20 & <=30'] += 1
# # # # #             elif overall_t5_mark <= 40:
# # # # #                 attendance_mark_dist.at[attendance_range, '>30 & <=40'] += 1
# # # # #             else:
# # # # #                 attendance_mark_dist.at[attendance_range, '>40 & <=60'] += 1
...
# # # # #         avg_t5_parts = df[['T5a', 'T5b', 'T5c', 'T5d']].sum(axis=1).mean()
# # # # #         avg_overall_t5 = df['Overall T5'].mean()

# # # # #         # Calculate and display the differences between averages
# # # # #         diff_t1_t5 = abs(avg_t1 - avg_t5_parts)
# # # # #         diff_t1_t2_t3 = abs(avg_t1 - avg_t2_t3)
# # # # #         diff_t5_combined = abs(avg_overall_t5 - (avg_t1 + avg_t2_t3 + avg_t5_parts))

# # # # #         st.write(f"**Difference between average marks of T1 & T5:** {diff_t1_t5:.2f} ({(diff_t1_t5 / avg_t1) * 100:.1f}%)")
# # # # #         st.write(f"**Difference between average marks of T1 & (T2 + T3):** {diff_t1_t2_t3:.2f} ({(diff_t1_t2_t3 / avg_t1) * 100:.1f}%)")
# # # # #         st.write(f"**Difference between average marks of T5 & (T1 + T2 + T3):** {diff_t5_combined:.2f} ({(diff_t5_combined / avg_overall_t5) * 100:.1f}%)")

# # # # #         # Plotting bell curves for each target
# # # # #         st.subheader("Marks Distribution (Bell Curves) for Each Target and Overall")
...
# # # # #         # Plot T5 combined parts distribution as a bell curve
# # # # #         plot_bell_curve(df[['T5a', 'T5b', 'T5c', 'T5d']].sum(axis=1), axes[1, 0], "Distribution of T5 Marks")

# # # # #         # Plot Overall T5 as a bell curve
# # # # #         plot_bell_curve(df['Overall T5'], axes[1, 1], "Distribution of Overall T5 Marks")
...
# # # #     df['Total'] = df['T1'] + df[['T2_Part1', 'T2_Part2', 'T3_Part1', 'T3_Part2']].sum(axis=1) + df[['T5a', 'T5b', 'T5c', 'T5d']].sum(axis=1)
# # # #     return df
...
# # # #         # Summary Table for Highest, Lowest, and Average Marks
# # # #         st.subheader("Summary of Highest, Lowest, and Average Marks")
# # # #         summary_data = {
...
# # # #             'T5': [df[['T5a', 'T5b', 'T5c', 'T5d']].sum(axis=1).max(), df[['T5a', 'T5b', 'T5c', 'T5d']].sum(axis=1).min(), df[['T5a', 'T5b', 'T5c', 'T5d']].sum(axis=1).mean()],
...
# # # #         # Summary of differences between averages for T1, T2 + T3, and T5
# # # #         st.subheader("Summary of Differences Between Averages")
# # # #         avg_t1 = df['T1'].mean()
# # # #         avg_t2_t3 = df[['T2_Part1', 'T2_Part2', 'T3_Part1', 'T3_Part2']].sum(axis=1).mean()
# # # #         avg_t5 = df[['T5a', 'T5b', 'T5c', 'T5d']].sum(axis=1).mean()
# # # #         avg_total = df['Total'].mean()

# # # #         diff_t1_t5 = abs(avg_t1 - avg_t5)
# # # #         diff_t1_t2_t3 = abs(avg_t1 - avg_t2_t3)
# # # #         diff_t5_total = abs(avg_total - (avg_t1 + avg_t2_t3 + avg_t5))

# # # #         st.write(f"**Difference between average marks of T1 & T5:** {diff_t1_t5:.2f} ({(diff_t1_t5 / avg_t1) * 100:.1f}%)")
# # # #         st.write(f"**Difference between average marks of T1 & (T2 + T3):** {diff_t1_t2_t3:.2f} ({(diff_t1_t2_t3 / avg_t1) * 100:.1f}%)")
# # # #         st.write(f"**Difference between average marks of Total & (T1 + T2 + T3 + T5):** {diff_t5_total:.2f} ({(diff_t5_total / avg_total) * 100:.1f}%)")
...
# # #             'T2': [df[['T2_Part1', 'T2_Part2']].sum(axis=1).max(), df[['T2_Part1', 'T2_Part2']].sum(axis=1).min(), df[['T2_Part1', 'T2_Part2']].sum(axis=1).mean()],
# # #             'T3': [df[['T3_Part1', 'T3_Part2']].sum(axis=1).max(), df[['T3_Part1', 'T3_Part2']].sum(axis=1).min(), df[['T3_Part1', 'T3_Part2']].sum(axis=1).mean()],
# # #             'T5 (Scaled to 20)': [df['Overall T5'].max(), df['Overall T5'].min(), df['Overall T5'].mean()],
# # #             'Total': [df['Total'].max(), df['Total'].min(), df['Total'].mean()]
# # #         }
...
# # #         for idx, row in df.iterrows():
# # #             attendance_range = get_attendance_range(row['Attendance'])
# # #             scaled_t5_mark = row['Overall T5']
# # #             if scaled_t5_mark <= 10:
# # #                 attendance_mark_dist.at[attendance_range, '<=10'] += 1
# # #             elif scaled_t5_mark <= 20:
# # #                 attendance_mark_dist.at[attendance_range, '>10 & <=20'] += 1
# # #             elif scaled_t5_mark <= 30:
# # #                 attendance_mark_dist.at[attendance_range, '>20 & <=30'] += 1
# # #             elif scaled_t5_mark <= 40:
# # #                 attendance_mark_dist.at[attendance_range, '>30 & <=40'] += 1
# # #             else:
# # #                 attendance_mark_dist.at[attendance_range, '>40 & <=60'] += 1

# # #         # Add a 'Total' column for each row and calculate the row sums
# # #         attendance_mark_dist['Total'] = attendance_mark_dist.sum(axis=1)
# # #         attendance_mark_dist.loc['Total'] = attendance_mark_dist.sum()

# # #         st.dataframe(attendance_mark_dist)

# # #         # Summary of differences between averages for T1, T2 + T3, and scaled T5
# # #         st.subheader("Summary of Differences Between Averages")
# # #         avg_t1 = df['T1'].mean()
# # #         avg_t2_t3 = df[['T2_Part1', 'T2_Part2', 'T3_Part1', 'T3_Part2']].sum(axis=1).mean()
...
# # #         diff_t1_t5 = abs(avg_t1 - avg_t5_scaled)
# # #         diff_t1_t2_t3 = abs(avg_t1 - avg_t2_t3)
# # #         diff_total = abs(avg_total - (avg_t1 + avg_t2_t3 + avg_t5_scaled))

# # #         st.write(f"**Difference between average marks of T1 & Scaled T5:** {diff_t1_t5:.2f} ({(diff_t1_t5 / avg_t1) * 100:.1f}%)")
# # #         st.write(f"**Difference between average marks of T1 & (T2 + T3):** {diff_t1_t2_t3:.2f} ({(diff_t1_t2_t3 / avg_t1) * 100:.1f}%)")
# # #         st.write(f"**Difference between average marks of Total & (T1 + T2 + T3 + Scaled T5):** {diff_total:.2f} ({(diff_total / avg_total) * 100:.1f}%)")
...
# # #         # Plot scaled T5 distribution as a bell curve
# # #         plot_bell_curve(df['Overall T5'], axes[1, 0], "Distribution of Scaled T5 Marks")
...
# #         # Display the attendance-based distribution table
# #         st.dataframe(attendance_mark_dist)

# #         # Summary of differences between averages for T1, T2 + T3, and Overall T5
# #         st.subheader("Summary of Differences Between Averages")
# #         avg_t1 = df['T1'].mean()
# #         avg_t2_t3 = df[['T2_Part1', 'T2_Part2', 'T3_Part1', 'T3_Part2']].sum(axis=1).mean()
# #         avg_t5 = df['Overall T5'].mean()
# #         avg_total = df['Total'].mean()

# #         diff_t1_t5 = abs(avg_t1 - avg_t5)
# #         diff_t1_t2_t3 = abs(avg_t1 - avg_t2_t3)
# #         diff_total = abs(avg_total - (avg_t1 + avg_t2_t3 + avg_t5))

# #         st.write(f"**Difference between average marks of T1 & Overall T5:** {diff_t1_t5:.2f} ({(diff_t1_t5 / avg_t1) * 100:.1f}%)")
# #         st.write(f"**Difference between average marks of T1 & (T2 + T3):** {diff_t1_t2_t3:.2f} ({(diff_t1_t2_t3 / avg_t1) * 100:.1f}%)")
# #         st.write(f"**Difference between average marks of Total & (T1 + T2 + T3 + Overall T5):** {diff_total:.2f} ({(diff_total / avg_total) * 100:.1f}%)")
...
# # Determine attendance range category for assigning additional marks
...
# # Determine attendance range category for reporting purposes
...
#         # Summary of Differences Between Averages
#         st.subheader("Summary of Differences Between Averages")
...
# Function to determine attendance range category for additional marks assignment
def get_adjustment_range(attendance):
    if attendance < 50:
        return '0-49%'
    elif 50 <= attendance < 65:
    ...
    if uploaded_file is not None:
        ...
        if "RegNo" in df.columns and "Grade" in df.columns and "Attendance" in df.columns:
            ...
            if st.button("Reassign Marks"):
                ...
                st.dataframe(df)  # Display updated marks
